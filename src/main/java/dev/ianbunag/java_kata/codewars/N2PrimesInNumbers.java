 ...
 * Challenge solution.
 */
public class N2PrimesInNumbers {
   ...
   * </ul>
   *
   * @param number Value to determine factors from.
  ...
  static class PrimeIterable implements Iterable<Integer> {
    /**
  ...
  static class PrimeIterator implements Iterator<Integer> {
    ...
    PrimeIterator(List<Integer> sourcePrimeList) {
